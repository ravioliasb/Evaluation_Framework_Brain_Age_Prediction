...
#Save Locations
validation_save_dir = "/work/wilms_lab/ravi/BrainAgeVoxelLevelPredictions_SPIEExtension/Adult_Real/Validation/"
test_save_dir = "/work/wilms_lab/ravi/BrainAgeVoxelLevelPredictions_SPIEExtension/Adult_Real/Test_Real/"
bias_save_dir = "/work/wilms_lab/ravi/BrainAgeVoxelLevelPredictions_SPIEExtension/Adult_Real/Bias/"
model_epoch_save_dir = "/work/wilms_lab/ravi/BrainAgeVoxelLevelPredictions_SPIEExtension/Adult_Real/Models/"



model_best_save_path = "/work/wilms_lab/ravi/UNET_Models_Real/Adult/translation_model.pth"
model_best_save_dir = "/work/wilms_lab/ravi/BrainAgeVoxelLevelPredictions_SPIEExtension/Adult_Real/BestModel/"



best_model_metrics_path = "/work/wilms_lab/ravi/BrainAgeVoxelLevelPredictions_SPIEExtension/Adult_Real/BestModel/BestModel.txt"
model_load_path = "sftp://arc.ucalgary.ca/home/ravi.bullock/UNET_Models_Real/Adult/translation_model.pth"
test_mae_save_path = "/work/wilms_lab/ravi/BrainAgeVoxelLevelPredictions_SPIEExtension/Adult_Real/Test_Real/MAE.txt"


#checkpoint_path = "/work/wilms_lab/ravi/BrainAgeVoxelLevelPredictions_SPIEExtension/Adult_Real/Models/translation_model31.pth"  #Resume from last to save time
checkpoint_path = ""
#Epochs
train_epochs = 101
...
#Synthetic Test
# with open("synthetic_splits/synthetic_adult_splits_longitudinal.pkl", "rb") as f:
    ...
    for epoch in range(start_epoch, train_epochs):
        ...
        for batch_data in tqdm(train_loader, desc=f"Epoch {epoch+1}/{train_epochs} (Training)", unit="batch"):
            ...
            with torch.amp.autocast('cuda', enabled=grad_scaler):
                ...
                noise = (torch.empty_like(target).uniform_(-2, 2))
            ...
            with torch.no_grad():
                for val_data in tqdm(val_loader, desc=f"Epoch {epoch+1}/{train_epochs} (Validation)", unit="batch"):
                    ...
                    with torch.amp.autocast('cuda',enabled=grad_scaler):
                        ...
                        val_noise = (torch.empty_like(val_target).uniform_(-2, 2))
            ...
            with torch.no_grad():
                ...
                with torch.amp.autocast('cuda',enabled=grad_scaler):
                    ...
                    for i in range(sample_input.shape[0]):
                        ...
                        sample_noise = (torch.empty_like(sample_target).uniform_(-2, 2))
...
if test_model:
    ...
    for test_data in tqdm(test_loader, total=len(test_loader), desc="Processing Test Samples"):
        ...
        for i in range(test_inputs.shape[0]):
            ...
            noised_target = test_label_i.item() + np.random.uniform(-2, 2, size=masked_values.shape)
