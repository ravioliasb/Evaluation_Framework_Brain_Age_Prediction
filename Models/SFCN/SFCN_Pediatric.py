...
checkpoint_filename="/work/wilms_lab/ravi/SFCN_Models_Real/Pediatric/SFCN_Pediatric_output.pt"
...
#Synthetic Test
# with open("/home/ravi.bullock/synthetic_splits/synthetic_pediatric_splits_crosssectional.pkl", "rb") as f:
...
#torch.save(net.state_dict(), "/work/wilms_lab/ravi/SFCN_Models_Real/Pediatric/SFCN_Pediatric_output.pt")

def predict_on_batch(engine, batch):
    net.eval()
    if evaluate_only:
        log_path = '/work/wilms_lab/ravi/spie_extension_models/SFCN_Pediatric_Real_test.txt'
    else:
...
# target_ages = [8, 12, 16, 18]

# # Define output directory
# output_base_dir = "/home/ravi.bullock/BrainAgeVoxelLevelPredictions_SPIEExtension/Pediatric_Real/XAI"
