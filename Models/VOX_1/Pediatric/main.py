...
if __name__ == "__main__":
    ...
    wandb.init(project="Roberto_Model_Pediatric", settings=wandb.Settings(start_method="fork"))
    ...
    #add wandb run name
    wandb.run.name = 'Roberto_Model_Pediatric_Run'
    ...
    ds_train, train_loader, ds_val, val_loader = load_data(args.root_dir, args.batch_size)
    ...
    train(train_loader, val_loader, model, optimizer, scheduler, max_epochs, root_dir, start_epoch)
