...
#     shuff_data = pd.read_csv(root_dir + "shuff_files_adult.csv")
...
def load_data(root_dir, batch):
    ...
    train_data = pd.read_csv(os.path.join(root_dir, "ukbb_train.csv"))
    val_data = pd.read_csv(os.path.join(root_dir, "ukbb_val.csv"))
