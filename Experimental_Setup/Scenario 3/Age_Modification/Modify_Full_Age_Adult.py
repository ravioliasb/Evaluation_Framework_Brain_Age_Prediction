...
save_base_dir = "/work/wilms_lab/ravi/FullField_AgeModified_Adult"
...
def svf_scaling_and_squaring(velo_field_itk, accuracy=16, compute_inverse=True):
    """
    Integrates the Stationary Velocity Field (SVF) to a Displacement Field.
    """
...
def process_single_subject(subject_id_str):
    ...
    def process_age_shift(target_age, prefix):
        ...
        velo_field = match_image_geometry(resample_to_reference(velo_field, itk_img_65), itk_img_65)
        ...
        warped_img = warper.Execute(itk_img_65, disp_field)
    ...
    process_age_shift(55, "Younger")
    process_age_shift(75, "Older")
